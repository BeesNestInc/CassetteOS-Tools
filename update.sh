#!/usr/bin/bash
#
#           CassetteOS Update Script v0.0.4
...
#   Usage:
#
#       $ wget -qO- https://github.com/BeesNestInc/CassetteOS-Tools/releases/download/v0.0.4/update.sh | sudo bash
#         or
#       $ curl -fsSL https://github.com/BeesNestInc/CassetteOS-Tools/releases/download/v0.0.4/update.sh | sudo bash
#
