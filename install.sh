#!/usr/bin/bash
#
#           CassetteOS Installer Script v0.0.5
...
#   Usage:
#
#       $ wget -qO- https://github.com/BeesNestInc/CassetteOS-Tools/releases/download/v0.0.5/install.sh | sudo bash
#         or
#       $ curl -fsSL https://github.com/BeesNestInc/CassetteOS-Tools/releases/download/v0.0.5/install.sh | sudo bash
#
...
# version
readonly CASSETTEOS_VERSION="v0.0.5"
((EUID)) && sudo_cmd="sudo"
