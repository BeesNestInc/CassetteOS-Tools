#!/usr/bin/bash
#
#           CassetteOS Installer Script v0.0.8
...
#   Usage:
#
#       $ wget -qO- https://github.com/BeesNestInc/CassetteOS-Tools/releases/download/v0.0.8/install.sh | sudo bash
#         or
#       $ curl -fsSL https://github.com/BeesNestInc/CassetteOS-Tools/releases/download/v0.0.8/install.sh | sudo bash
#
...
# version
readonly CASSETTEOS_VERSION="v0.0.8"
((EUID)) && sudo_cmd="sudo"
