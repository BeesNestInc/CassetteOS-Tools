#!/usr/bin/bash
#
#           CassetteOS Installer Script v0.0.10
...
#   Usage:
#
#       $ wget -qO- https://github.com/BeesNestInc/CassetteOS-Tools/releases/download/v0.0.10/install.sh | sudo bash
#         or
#       $ curl -fsSL https://github.com/BeesNestInc/CassetteOS-Tools/releases/download/v0.0.10/install.sh | sudo bash
#
